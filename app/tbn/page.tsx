      ...
      <section style={{ padding: "4rem clamp(1.5rem, 5vw, 4rem)", maxWidth: "1320px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 3fr", gap: "4rem", alignItems: "start", borderBottom: "1px solid #e2ded9" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
            ...
            <a href="/tbn_presentation_portfolio.pdf" target="_blank" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", padding: "0.75rem 2rem", background: "transparent", color: "#1a1814", border: "1.5px solid #e2ded9", borderRadius: "2px", fontSize: "0.75rem", fontWeight: 400, letterSpacing: "0.06em", textTransform: "uppercase", textDecoration: "none" }}>
